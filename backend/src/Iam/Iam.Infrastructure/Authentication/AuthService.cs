...
public class AuthService(SignInManager<PersistenceUser> signInManager, UserManager<PersistenceUser> userManager)
	: IAuthService
{
	...
	private static readonly Error RegistrationFailedError = new(
		"Iam.RegistrationFailed",
		"Registration failed",
		null,
		ErrorType.Conflict);
